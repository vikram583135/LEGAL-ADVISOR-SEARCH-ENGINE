<%@ Page Title="" Language="C#" MasterPageFile="~/usermaster.master" AutoEventWireup="true" CodeFile="userbcity.aspx.cs" Inherits="userbcity" %>
...
Select City:&nbsp;<asp:DropDownList ID="DropDownList1" runat="server" 
    ...
    Legal Adviser Details:
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            CellPadding="4" DataKeyNames="b_id" DataSourceID="SqlDataSource2" Width="637px">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ConnectionString="<%$ ConnectionStrings:business_directoryConnectionString %>" 
            SelectCommand="SELECT * FROM [business_details] WHERE ([city] = @city)">
            <SelectParameters>
